...
void nbody_v1(int argc, const char *argv[], int stream)
{
	double ttotal, tinit = 0, tforces = 0, tmove = 0;
...
void nbody_v2(int argc, const char *argv[], int stream)
{
	double ttotal, tinit = 0, tforces = 0, tmove = 0;
...
void nbody_v3(int argc, const char *argv[], int stream)
{
	double ttotal, tinit = 0, tforces = 0, tmove = 0;
...
void nbody_v4(int argc, const char *argv[], int stream)
{
	double ttotal, tinit = 0, tforces = 0, tmove = 0;
...
void nbody_v5(int argc, const char *argv[], int stream)
{
	double ttotal, tinit = 0, tforces = 0, tmove = 0;
...
int main(int argc, char const *argv[])
{
	...
	for (int i = 2; i <= 4; i+=2) {
		...
		nbody_v1(argc, argv, i);
		nbody_v2(argc, argv, i);
		nbody_v3(argc, argv, i);
		nbody_v4(argc, argv, i);
		nbody_v5(argc, argv, i);
	}
